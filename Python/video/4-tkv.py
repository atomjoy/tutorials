...
if __name__ == '__main__':
    ...
    skip_backward = PhotoImage(file='backward.png')
    skip_forward = PhotoImage(file='forward.png')
    loading_gif = PhotoImage(file='play.png')
    ...
    if video_path:
        ...
        player = VideoPlayer(root, video_path, audio_path, video_label, size=(700, 500),
                             ...
                             slider=slider, slider_var=slider_var, keep_ratio=True, cleanup_audio=True,loading_gif=loading_gif)
    else:
