...
widgets_frame.grid(row=0, column=0, padx=20, pady=0)
...
# secret_entry = ttk.Entry(widgets_frame)
# secret_entry.insert(0, "Secret")
# secret_entry.bind("<FocusIn>", lambda e: secret_entry.delete('0', 'end'))
# secret_entry.grid(row=1, column=0, padx=5, pady=(0, 5), sticky="ew")
...
button = ttk.Button(widgets_frame, text="Insert", command=lambda: insert_row(path))
